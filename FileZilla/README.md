I used FileZilla to transfer the files from the website's GitHub (https://github.com/taimaishuze/sootsplash.html) repository over to the Sootsplash server (https://sootsplash.csci2461.com).
